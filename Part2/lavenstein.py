...
order_to_products_mapping = {'5269129170': ['PR12ERT45', 'PR45GHT98', 'PR04DEF04', 'PR13JKL13', 'PR14JKL14'],
                    '4269129163': ['PR01ABC01', 'PR06DEF06', 'PR22STU22'],
                    '3269129163': ['PR12ERT45', 'PR20PQR20', 'PR35ERT35', 'PR39GHT39'],
                    '6269129163': ['PR06DEF06', 'PR10GHI10', 'PR15MNO15', 'PR16MNO16'],
                    '7269129163': ['PR26XYZ26', 'PR28XYZ28', 'PR29XYZ29', 'PR48GHT48', 'PR49GHT49'],
                    '8269129155': ['PR28XYZ28', 'PR29XYZ29', 'PR48GHT48', 'PR49GHT49']}

order_ids = ['5269129170', '4269129163', '3269129163', '6269129163', '7269129163', '8269129155']

shelves_list = [['R1', 'G1', 'C1', 'D1', 'D2'], 
                ['A1', 'C3', 'B1'], 
                ['R1', 'S1', 'BG1', 'FA1'],
                ['C3', 'R1', 'M1', 'M2'], 
                ['P1', 'P3', 'P4', 'G6', 'G7'], 
...
aisles =  ['RGCD', 'ACB', 'RSBA', 'CRM', 'PG', 'PG']     #list will be generated by part1 code
length = len(aisles)
