...
for j in range(0,len(fileList)):
    with open(fileList[i],"r") as read_file:
        jsonInput = json.load(read_file)                    #read json input file
        #print(jsonInput)

        orderList.append(jsonInput['orderNo'])
        print("List of all ordernumbers from multiple json inputs till now:") #sam this is your orderNo list :P
        print(orderList)
        ...
        with open('Desktop/products.csv', 'r') as file:      #read csv file
            ...
            print(aisleList)  #sam this is your aisle strings chi list :P
